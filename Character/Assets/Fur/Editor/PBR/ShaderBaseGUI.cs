...
using RenderHDEditor;

namespace UnityEditor
{
    public abstract class ShaderBaseGUI : ShaderGUI
    {
        ...
        {
            // Catergories
            public static readonly GUIContent FurInputs =
                new GUIContent("Fur Inputs", "These settings describe the look and feel of the fur itself.");
        ...
        protected MaterialProperty _NoiseMap { get; set; }
        protected MaterialProperty _MaskMap { get; set; }
        protected MaterialProperty _FurLength { get; set; }
        protected MaterialProperty _GravityStrength { get; set; }
        protected MaterialProperty _FurUVOffset { get; set; }
        protected MaterialProperty _Thickness { get; set; }
        protected MaterialProperty _Blur { get; set; }
        protected MaterialProperty _OcclusionColor { get; set; }
        protected MaterialProperty _SpecColor1 { get; set; }
        protected MaterialProperty _SpecColor2 { get; set; }
        protected MaterialProperty _SpecShift1 { get; set; }
        protected MaterialProperty _SpecShift2 { get; set; }
        protected MaterialProperty _SpecSmooth1 { get; set; }
        protected MaterialProperty _SpecSmooth2 { get; set; }
        protected MaterialProperty _Glossiness1 { get; set; }
        protected MaterialProperty _Glossiness2 { get; set; }
        ...
        {
            _NoiseMap = FindProperty("_NoiseMap", properties);
            _MaskMap = FindProperty("_MaskMap", properties);
            _FurLength = FindProperty("_FurLength", properties);
            _GravityStrength = FindProperty("_GravityStrength", properties);
            _FurUVOffset = FindProperty("_FurUVOffset", properties);
            ...
            _SpecColor1 = FindProperty("_SpecColor1", properties);
            _SpecColor2 = FindProperty("_SpecColor2", properties);
            _SpecShift1 = FindProperty("_SpecShift1", properties);
            _SpecShift2 = FindProperty("_SpecShift2", properties);
            _SpecSmooth1 = FindProperty("_SpecSmooth1", properties);
            _SpecSmooth2 = FindProperty("_SpecSmooth2", properties);
            _Glossiness1 = FindProperty("_Glossiness1", properties);
            _Glossiness2 = FindProperty("_Glossiness2", properties);
        ...
        public virtual void OnOpenGUI(Material material, MaterialEditor materialEditor)
        {
            ...
            m_FurInputsFoldout = new SavedBool($"{m_HeaderStateKey}.FurInputsFoldout", true);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            m_FurInputsFoldout.value = EditorGUILayout.BeginFoldoutHeaderGroup(m_FurInputsFoldout.value, Styles.FurInputs);
            if (m_FurInputsFoldout.value)
            {
                DrawFurInputs(material);
                EditorGUILayout.Space();
            }
            EditorGUILayout.EndFoldoutHeaderGroup();
        ...
        public virtual void DrawFurInputs(Material material)
        {
            materialEditor.TexturePropertySingleLine(new GUIContent("NoiseMap"), _NoiseMap);
            materialEditor.TextureScaleOffsetProperty(_NoiseMap);
            if (_MaskMap != null)
            {
                materialEditor.TexturePropertySingleLine(new GUIContent("MaskMap"), _MaskMap);
                if (material.HasProperty("_MaskMap"))
                {
                    material.SetTexture("_MaskMap", _MaskMap.textureValue);
                    var baseMapTiling = _MaskMap.textureScaleAndOffset;
                    material.SetTextureScale("_MaskMap", new Vector2(baseMapTiling.x, baseMapTiling.y));
                    material.SetTextureOffset("_MaskMap", new Vector2(baseMapTiling.z, baseMapTiling.w));
                }
            }
            EditorGUILayout.Space();
            EditorGUILayout.LabelField("Sculpt");
            EditorGUI.indentLevel++;
            materialEditor.ShaderProperty(_FurLength, "FurLength");
            materialEditor.ShaderProperty(_GravityStrength, "GravityStrength");
            materialEditor.ShaderProperty(_FurUVOffset, "FurUVOffset");
            materialEditor.ShaderProperty(_Thickness, "Thickness");
            materialEditor.ShaderProperty(_Blur, "Blur");
            EditorGUI.indentLevel--;

            EditorGUILayout.Space();
            EditorGUILayout.LabelField("AO");
            EditorGUI.indentLevel++;
            materialEditor.ShaderProperty(_OcclusionColor, "OcclusionColor");
            EditorGUI.indentLevel--;

            EditorGUILayout.Space();
            EditorGUILayout.LabelField("Specular");
            EditorGUI.indentLevel++;
            materialEditor.ShaderProperty(_SpecColor1, "SpecColor1");
            materialEditor.ShaderProperty(_SpecColor2, "SpecColor2");
            materialEditor.ShaderProperty(_SpecShift1, "SpecShift1");
            materialEditor.ShaderProperty(_SpecShift2, "SpecShift2");
            materialEditor.ShaderProperty(_SpecSmooth1, "SpecSmooth1");
            materialEditor.ShaderProperty(_SpecSmooth2, "SpecSmooth2");
            materialEditor.ShaderProperty(_Glossiness1, "Glossiness1");
            materialEditor.ShaderProperty(_Glossiness2, "Glossiness2");
            EditorGUI.indentLevel--;
        }
